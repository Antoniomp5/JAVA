...
public class TestEventoMusica {

    public static void main(String[] args) {

        List<Musical> eventos = new ArrayList<>();
        ...
        // ===== EVENTO 2 =====
        Musical electroNight = new Musical(
                "Electro Night",
