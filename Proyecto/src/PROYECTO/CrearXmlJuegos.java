...
public class CrearXmlJuegos {
	...
	public static void guardarJuegos(Map<Integer, Juegos> juegos) {
	    ArrayList<Juegos> listaJuegos = new ArrayList<>(juegos.values());
